...
```bash
# Mac OS X
curl -L https://github.com/mattes/fugu/releases/download/v0.1.0/fugu.v0.1.0.darwin.x86_64.tar.gz | tar xvz
mv fugu.v0.1.0.darwin.x86_64 /usr/local/bin/fugu
chmod +x /usr/local/bin/fugu

# Linux
curl -L https://github.com/mattes/fugu/releases/download/v0.1.0/fugu.v0.1.0.linux.x86_64.tar.gz | tar xvz
mv fugu.v0.1.0.linux.x86_64 /usr/local/bin/fugu
chmod +x /usr/local/bin/fugu
